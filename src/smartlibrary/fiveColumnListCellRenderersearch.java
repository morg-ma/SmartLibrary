...
public class fiveColumnListCellRenderersearch extends JPanel implements ListCellRenderer<Object> {
    ...
    public fiveColumnListCellRenderersearch(ImageIcon background) {

...
import SmartLibrary.Customerdata;
            ...
            if (booksind >= 0) {
                if (flag == 1) {   // flag 1 customer exsist
                    ...
                    if (f) {
                        ...
                        JOptionPane.showMessageDialog(null, "Data already exist or not correct or name or email not valid", "Warnning", JOptionPane.WARNING_MESSAGE);

                    }
                } else if (flag == 2) // flag not choose any thing 
                {
                    JOptionPane.showMessageDialog(null, "Choose new or Exist Customer", "Warnning", JOptionPane.WARNING_MESSAGE);
                } else {
